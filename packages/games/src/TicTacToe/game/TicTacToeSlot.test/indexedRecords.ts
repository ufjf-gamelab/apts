...
const {
  ...
  recordOfTicTacToeSlotsWithDataAndIndex:
    recordOfTicTacToeSlotsWithDataAndIndexInWhichSlotsR0C0AndR0C1AreFilledByAliceAndR1C0IsFilledByBruno,
} = createIndexedTicTacToeSlotsWithData({
  keysOfTicTacToeSlotsInOrder,
  ticTacToeSlotsWithData:
    recordOfTicTacToeSlotsWithDataInWhichSlotsR0C0AndR0C1AreFilledByAliceAndR1C0IsFilledByBruno,
...
const {
  ...
  recordOfTicTacToeSlotsWithDataAndIndex:
    recordOfTicTacToeSlotsWithDataAndIndexInWhichSlotsR0C0AndR1C0AreFilledByAliceAndR2C2IsFilledByBruno,
} = createIndexedTicTacToeSlotsWithData({
  keysOfTicTacToeSlotsInOrder,
  ticTacToeSlotsWithData:
    recordOfTicTacToeSlotsWithDataInWhichSlotsR0C0AndR1C0AreFilledByAliceAndR2C2IsFilledByBruno,
...
const {
  ...
  recordOfTicTacToeSlotsWithDataAndIndex:
    recordOfTicTacToeSlotsWithDataAndIndexInWhichSlotsR0C1AndR1C0AndR1C1AreFilledByAliceAndR0C0AndR2C1AreFilledByBruno,
} = createIndexedTicTacToeSlotsWithData({
  keysOfTicTacToeSlotsInOrder,
  ticTacToeSlotsWithData:
    recordOfTicTacToeSlotsWithDataInWhichSlotsR0C1AndR1C0AndR1C1AreFilledByAliceAndR0C0AndR2C1AreFilledByBruno,
