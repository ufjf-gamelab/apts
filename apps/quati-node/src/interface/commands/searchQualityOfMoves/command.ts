...
const commandToSearchQualityOfMoves = {
  ...
  options: [
    ...
    new Option(
      ...
      "The name of the folder that will be created to contain the image file of the search tree.",
    ),
    commonOptions.seed,
    new Option(
      "--probabilities",
